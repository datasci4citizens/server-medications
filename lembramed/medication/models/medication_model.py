...
class Medication(TimeStampedModel):
    ...
    active_ingredients = models.ManyToManyField(Active_Ingredient, on_delete=models.SET_NULL, related_name='medications', blank=True)

    presentation = models.ManyToManyField(Presentation, related_name='medications', on_delete=models.SET_NULL)
